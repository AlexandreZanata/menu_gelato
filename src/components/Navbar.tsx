  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2 font-display text-xl sm:text-2xl font-bold text-primary hover:opacity-80 transition-opacity">
          <IceCreamCone className="h-7 w-7 sm:h-8 sm:w-8 shrink-0" />
          <span className="whitespace-nowrap">Gelato Dreams</span>
        </Link>
